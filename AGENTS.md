# AGENTS.md — rules for any agent working on the NoeticWeave **codebase**

> This governs development of NoeticWeave itself (CodeX, Claude, etc.). It is **not** the schema
...
NoeticWeave is the **tool + framework + methodology** for an AI-maintained, linked-markdown
...
Lead with these; they are why NoeticWeave exists (see `docs/positioning.md`):
