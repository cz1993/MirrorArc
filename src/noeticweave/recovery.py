...
"""Print a read-only recovery checklist from NoeticWeave manifests."""
...
from noeticweave.runtime_profile import configured_office_mirror_root, repo_notes_dirs
...
def print_human(root: Path, items: list[dict], warnings: list[str], errors: list[str]) -> None:
    print(f"noeticweave recovery: {root}")
...
def print_worksheet(root: Path, items: list[dict], warnings: list[str], errors: list[str]) -> None:
    ...
    print("# NoeticWeave Recovery Worksheet")
    print()
    print("Generated by `noeticweave recovery --worksheet`. Read-only; no files were changed.")
    print()
    print("## Summary")
    print()
    ...
    print("- Resolve one item at a time, then rerun `noeticweave status` and `noeticweave recovery`.")
    ...
    print("- Run `noeticweave catalog` and `noeticweave lint` after recovery work is complete.")
    print()
...
def print_runbook(root: Path, items: list[dict], warnings: list[str], errors: list[str]) -> None:
    ...
    print("# NoeticWeave Recovery Runbook")
    print()
    print("Generated by `noeticweave recovery --runbook`. Read-only; no files were changed.")
    print()
    print("## Summary")
    print()
    print(f"- Vault root: `{md_escape(root)}`")
    ...
    print("- After every batch, rerun `noeticweave status`, `noeticweave recovery`, `noeticweave catalog`, and `noeticweave lint`.")
    print()
    ...
    print_runbook_section(
        ...
        protocol=[
            ...
            "Move real human notes into a curated note or run `noeticweave migrate annotations --write` before regeneration.",
    ...
    print()
    print("- [ ] `noeticweave status` shows no unexpected review-blocking states.")
    print("- [ ] `noeticweave recovery` reports no remaining operator-action items or only accepted deferrals.")
    print("- [ ] `noeticweave catalog --check` passes after catalog regeneration.")
    print("- [ ] `noeticweave lint` passes.")
    print("- [ ] Private pilot notes record what was restored, archived, retired, or regenerated.")
    print()


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Print a read-only NoeticWeave recovery checklist.")
