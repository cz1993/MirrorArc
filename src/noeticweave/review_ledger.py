...
"""Record and summarize human review decisions for generated NoeticWeave artifacts.
...
def build_parser(default_root: Path | None = None) -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Record and summarize NoeticWeave review ledger events.")
    parser.add_argument(
        "--root",
        type=Path,
