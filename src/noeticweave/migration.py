...
from noeticweave.profiles import ProfileValidationError, load_profile
...
def print_worksheet(root: Path, items: list[dict], frontmatter_items: list[dict], warnings: list[str], errors: list[str]) -> None:
    ...
    print("# NoeticWeave Migration Review Worksheet")
    print()
    print("Generated by `noeticweave migration --worksheet`. Dry-run only; no files were moved.")
    print()
    print("## Summary")
    print()
    ...
    print("- Run `noeticweave migration`, `noeticweave catalog`, and `noeticweave lint` after each batch.")
...
def print_runbook(root: Path, items: list[dict], frontmatter_items: list[dict], warnings: list[str], errors: list[str]) -> None:
    summary = summary_counts(items)
    frontmatter_summary = frontmatter_summary_counts(frontmatter_items)
    print("# NoeticWeave Legacy Folder Migration Runbook")
    print()
    print("Generated by `noeticweave migration --runbook`. Read-only; no files were moved or changed.")
    print()
    print("## Current Queue")
    print()
    print(f"- Vault root: `{md_escape(root)}`")
    ...
    print("- Resolve `noeticweave recovery --worksheet` items before trusting generated mirrors.")
    print("- Treat unknown folders/domains as classification decisions, not automatic moves.")
    print()
    print("## Execution Sequence")
    print()
    print("1. Run `noeticweave migration --worksheet` and review the folder/domain queue.")
    print("2. Run `noeticweave migration --normalize-frontmatter-domains --worksheet`.")
    print("3. If approved, run `noeticweave migration --normalize-frontmatter-domains --write`.")
    print(
    ...
    print("7. Regenerate `noeticweave catalog` and `noeticweave catalog --html`.")
    print("8. Run `noeticweave migration`, `noeticweave recovery --worksheet`, and `noeticweave lint`.")
    ...
    print()
    print("- Stop if `noeticweave recovery --worksheet` reports missing sources, conflicts, or manual generated edits.")
    print("- Stop if `noeticweave lint` reports broken links, invalid domains, or stale mirrors.")
...
def print_human(root: Path, items: list[dict], frontmatter_items: list[dict], warnings: list[str], errors: list[str]) -> None:
    print(f"noeticweave migration: {root}")
...
def print_normalize_frontmatter_domains(
    ...
    *,
    ...
    print(f"noeticweave migration normalize-frontmatter-domains: {root}")
...
def print_normalize_frontmatter_domains_worksheet(
    ...
    print("# NoeticWeave Frontmatter Domain Normalization Worksheet")
    print()
    print(
        "Generated by `noeticweave migration --normalize-frontmatter-domains --worksheet`. "
    ...
    print("- After approval, run `noeticweave migration --normalize-frontmatter-domains --write`.")
    print("- Then regenerate `noeticweave catalog` and run `noeticweave lint`.")
    print()
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Report NoeticWeave folder/frontmatter migration work.")
