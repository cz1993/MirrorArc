...
from mirrorarc.changes import feed
from mirrorarc.runtime_profile import profile_content_roots
...
def build_watchdog_observer(root: Path) -> tuple[Any, BufferedNativeEventHandler, list[Path]]:
    ...
    try:
        ...
        raise WatchdogUnavailable("install the optional watch extra: mirrorarc[watch]") from exc
