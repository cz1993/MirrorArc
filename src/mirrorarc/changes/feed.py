...
from mirrorarc.changes.events import JournalEventError, normalize_vault_relative_path, validate_event_kind
from mirrorarc.runtime_profile import configured_office_mirror_root, rel_is_under, repo_notes_dirs

LOCAL_STATE_DIRS = {Path(".mirrorarc"), Path(".vaultwright")}
OPERATIONAL_DIRS = {
    ".git",
    ".githooks",
    ".github",
