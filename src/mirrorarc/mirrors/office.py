...
`mirrorarc migrate annotations --write` before sync refreshes the mirror.
...
AMBIGUOUS_SOURCE_MOVE_ERROR = (
    "Source bytes match multiple missing manifest records; MirrorArc cannot choose the correct "
