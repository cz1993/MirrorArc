...
"""Print a read-only recovery checklist from MirrorArc manifests."""
...
from mirrorarc.runtime_profile import configured_office_mirror_root, repo_notes_dirs
...
def print_human(root: Path, items: list[dict], warnings: list[str], errors: list[str]) -> None:
    print(f"mirrorarc recovery: {root}")
...
def print_worksheet(root: Path, items: list[dict], warnings: list[str], errors: list[str]) -> None:
    ...
    print("# MirrorArc Recovery Worksheet")
    print()
    print("Generated by `mirrorarc recovery --worksheet`. Read-only; no files were changed.")
    print()
    print("## Summary")
    print()
    ...
    print("- Resolve one item at a time, then rerun `mirrorarc status` and `mirrorarc recovery`.")
    ...
    print("- Run `mirrorarc catalog` and `mirrorarc lint` after recovery work is complete.")
    print()
...
def print_runbook(root: Path, items: list[dict], warnings: list[str], errors: list[str]) -> None:
    ...
    print("# MirrorArc Recovery Runbook")
    print()
    print("Generated by `mirrorarc recovery --runbook`. Read-only; no files were changed.")
    print()
    print("## Summary")
    print()
    print(f"- Vault root: `{md_escape(root)}`")
    ...
    print("- After every batch, rerun `mirrorarc status`, `mirrorarc recovery`, `mirrorarc catalog`, and `mirrorarc lint`.")
    print()
    ...
    print_runbook_section(
        ...
        protocol=[
            ...
            "Move real human notes into a curated note or run `mirrorarc migrate annotations --write` before regeneration.",
    ...
    print()
    print("- [ ] `mirrorarc status` shows no unexpected review-blocking states.")
    print("- [ ] `mirrorarc recovery` reports no remaining operator-action items or only accepted deferrals.")
    print("- [ ] `mirrorarc catalog --check` passes after catalog regeneration.")
    print("- [ ] `mirrorarc lint` passes.")
    print("- [ ] Private pilot notes record what was restored, archived, retired, or regenerated.")
    print()


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Print a read-only MirrorArc recovery checklist.")
