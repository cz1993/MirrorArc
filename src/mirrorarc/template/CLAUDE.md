...
This is the **schema layer** of a MirrorArc knowledge base: the operating manual that turns an
...
- **Rules:** edit the original, never a generated mirror body. Keep durable human notes in regular
  ...
  `mirrorarc migrate annotations --write` before sync refreshes it. Mirror generation is
