...
"""Record and summarize human review decisions for generated MirrorArc artifacts.
...
def build_parser(default_root: Path | None = None) -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Record and summarize MirrorArc review ledger events.")
    parser.add_argument(
        "--root",
        type=Path,
