...
"NoeticWeave" and the NoeticWeave logo (the "Marks") are trademarks of Ci Zhu (cz1993)
...
- state truthfully that your project "uses NoeticWeave" or is "compatible with NoeticWeave"
  (nominative use);
- keep the Marks intact in unmodified redistributions.

**You may not**, without written permission:

- name a modified version or a fork "NoeticWeave," or use the Marks as your product's name/logo;
