---
title: Start here — Ontario Grid Evidence Workspace
type: hub
status: active
domain: context
created: 2026-07-19
...
tags: [index, ontario-grid, evidence-workspace]
related: ["[[Demo walkthrough]]", "[[Evidence layers and trust]]", "[[Public source register]]"]
---

# Start here — Ontario Grid Evidence Workspace
...
> energy material and labelled synthetic fixtures. It is not a live grid product, it is not the
> GuildBuild OntarioGrid repository, and it contains no private project material.
...
1. **Read the workspace story.** Open [[Ontario Grid Evidence Workspace overview]] to understand
...
2. **See the evidence chain.** Open [[Evidence layers and trust]], then choose **Relationship map**.
   Follow an original Office, spreadsheet, PDF, or repository record into its generated Markdown
...
4. **Inspect a real decision gate.** Open [[Forecast publication gate]]. The synthetic result stays
   suppressed because its 7.7% error exceeds the 5% threshold—documentation records the decision
...
- **The documentation layer accumulates knowledge.** Contracts, findings, model gates, decisions,
...
- [[Ontario Grid Evidence Workspace overview]]
...
- [[Electricity emissions contract]]
...
- [[Electricity emissions finding]]
- [[Cross-source evidence synthesis]]

### Models and outputs

- [[Historical peak model card]]
- [[Illustrative model evaluation]]
