...
related: ["[[Evidence controls]]", "[[Source freshness policy]]", "[[Quality gate pipeline]]"]
---
...
| Historical result presented as current | Snapshot date is omitted | Coverage labels and source-freshness policy |
