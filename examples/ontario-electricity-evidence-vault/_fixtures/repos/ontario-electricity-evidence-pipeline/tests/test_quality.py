...
class QualityTests(unittest.TestCase):
    ...
    def test_empty_or_invalid_history_fails_closed(self) -> None:
        self.assertFalse(annual_demand_complete([]))
        self.assertFalse(peak_exceeds_minimum([MonthlyDemandRange(2023, "July", 11987, 22686)]))
