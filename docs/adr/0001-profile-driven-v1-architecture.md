...
**Status:** Accepted
**Date:** 2026-06-23
**Decision source:** `docs/MIRRORARC_WHITEPAPER_2026-06-23.md`
**Owner:** cz1993

## Context

MirrorArc started as a business-operations vault template with copied vault-local tools. The
...
MirrorArc v1 will converge on this product statement:
...
MirrorArc v1 will support exactly three maintained content profiles plus a minimal blank starter:
...
Runtime code should converge into the installed `src/mirrorarc/` package. Vault-local tools may
