# Codex Mega Prompt — Converge NoeticWeave to Profile-Driven V1 with Journaled Incremental Materialization

> Historical prompt. This file is not the current execution authority; do not use it as the
> current kickoff prompt. Use
> `docs/CODEX_KICKOFF_PROMPT.md`, `docs/NOETICWEAVE_WHITEPAPER.md`,
...
Paste this prompt into Codex while it is opened at the root of `cz1993/noeticweave`.

---

You are the principal engineer, architecture steward, test owner, and release-convergence lead for **NoeticWeave**.
...
docs/revisions/NOETICWEAVE_WHITEPAPER_2026-06-24.md
docs/NOETICWEAVE_WHITEPAPER_2026-06-23.md
...
docs/RECOVERY.md
docs/RELEASE.md
src/noeticweave/profiles.py
src/noeticweave/mirrors/office.py
src/noeticweave/mirrors/github_repos.py
src/noeticweave/cli.py
src/noeticweave/lifecycle_contract.py
...
If the June 24 whitepaper is not yet canonical, adopt it into `docs/NOETICWEAVE_WHITEPAPER.md`
...
```text
src/noeticweave/changes/__init__.py
src/noeticweave/changes/journal.py
src/noeticweave/changes/models.py
src/noeticweave/changes/coalesce.py
src/noeticweave/changes/reconcile.py
src/noeticweave/changes/watcher.py
src/noeticweave/changes/worker.py
src/noeticweave/locking.py
```
