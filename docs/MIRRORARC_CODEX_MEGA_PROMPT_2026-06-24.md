# Codex Mega Prompt — Converge MirrorArc to Profile-Driven V1 with Journaled Incremental Materialization

> Historical prompt. This file is not the current execution authority; do not use it as the
> current kickoff prompt. Use
> `docs/CODEX_KICKOFF_PROMPT.md`, `docs/MIRRORARC_WHITEPAPER.md`,
...
Paste this prompt into Codex while it is opened at the root of `cz1993/MirrorArc`.

---

You are the principal engineer, architecture steward, test owner, and release-convergence lead for **MirrorArc**.
...
docs/revisions/MIRRORARC_WHITEPAPER_2026-06-24.md
docs/MIRRORARC_WHITEPAPER_2026-06-23.md
...
docs/RECOVERY.md
docs/RELEASE.md
src/mirrorarc/profiles.py
src/mirrorarc/mirrors/office.py
src/mirrorarc/mirrors/github_repos.py
src/mirrorarc/cli.py
src/mirrorarc/lifecycle_contract.py
...
If the June 24 whitepaper is not yet canonical, adopt it into `docs/MIRRORARC_WHITEPAPER.md`
...
```text
src/mirrorarc/changes/__init__.py
src/mirrorarc/changes/journal.py
src/mirrorarc/changes/models.py
src/mirrorarc/changes/coalesce.py
src/mirrorarc/changes/reconcile.py
src/mirrorarc/changes/watcher.py
src/mirrorarc/changes/worker.py
src/mirrorarc/locking.py
```
